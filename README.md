...
PyPoll
Python Script for analysis of a town vote-counting process.Provided a set of poll data called election_data.csv. The dataset is composed of three columns: Ballot ID, County, and Candidate.
